...
INSERT INTO bags 
SET id="", name="UCI Bootcamp Student Bag", model="Universal Plastic", quantity=1, price=00.10, color="White", material="Plastic", SKU = "No one cares", image="https://images-na.ssl-images-amazon.com/images/I/81sbXw5yIAL._SY355_.jpg", description= "Hang in there buddy.", sold = "FALSE", bought_by="x";
